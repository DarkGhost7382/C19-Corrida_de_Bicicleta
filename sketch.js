...
mainCyclist.setCollider ("circle", -150, 0, 500); //Deixei assim pois para mim foi a melhor medida do colisor
...
function draw() {
  ...
  if (World.frameCount % 150 == 0) {
   ...
   if(pinkCG.isTouching(mainCyclist)){
    ...
    textSize (20);
    text ("Pressione seta pra cima para reiniciar", 485, 190, 400, 100);
